...
public final class Bootstrap {
  public static final class Components {
    public final CityPackFactory cityPack;
    public final Router router;
    public final MetricsRegistry metrics;
    public final World world;
    public final SimulationFacade simulation;

    Components(
        CityPackFactory cityPack,
        Router router,
        MetricsRegistry metrics,
        World world,
        SimulationFacade simulation) {
  ...
  public static Components init() {
    ...
    World world =
        new metrosim.services.scenario.ScenarioBuilder()
            .addVehicle("V-1", 0, 50)
            .addVehicle("V-2", 25, 0)
            .build();
  ...
  private static CityPackFactory resolveCityPack() {
    ...
    CityPackFactory chosen = fallback;
    ...
    for (CityPackFactory f : loader) {
      ...
      if (!(f instanceof DefaultPackFactory) && chosen instanceof DefaultPackFactory) {
        chosen = f;
      }
    }
    return chosen;
